...
const SignUpPage = () => {
  ...
  // This is how we did it first, without using custom hooks
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                <div className='form-control w-full'>
                  ...
                  fullName: e.target.value })} required />
                </div>
                ...
                <div className='form-control'>
                  <label className='label cursor-pointer justify-start gap-2'>
                    ...
                    <span className='text-xs leading-tight'>
                      I agree to the{" "}
                      <span className='tet-primry hover:underline'>terms of service</span> and{" "}
              ...
              <button className='btn btn-primary w-full' type='submit'>
                { isPending ? (
                  <>
                  <span className='loading loading-spinner leading-xs'>
                    Loading...
                  </span>
                  </>
                ) : ("Create Account")}
